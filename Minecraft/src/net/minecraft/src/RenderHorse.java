...
public class RenderHorse extends RenderLiving
{
	...
	{
		return func_110849_a((EntityHorse) par1Entity);
	}
	...
	protected ResourceLocation func_110849_a(EntityHorse par1EntityHorse)
	{
		...
		} else return func_110848_b(par1EntityHorse);
	}
	
	@Override protected void preRenderCallback(EntityLivingBase par1EntityLivingBase, float par2)
	{
		func_110847_a((EntityHorse) par1EntityLivingBase, par2);
	}
	...
	{
		func_110846_a((EntityHorse) par1EntityLivingBase, par2, par3, par4, par5, par6, par7);
	}
}
