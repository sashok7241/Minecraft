...
public class RenderCreeper extends RenderLiving
{
	...
	@Override protected int getColorMultiplier(EntityLiving par1EntityLivingBase, float par2, float par3)
	{
		return updateCreeperColorMultiplier((EntityCreeper) par1EntityLivingBase, par2, par3);
	}
	
	@Override protected int inheritRenderPass(EntityLiving par1EntityLivingBase, int par2, float par3)
	{
