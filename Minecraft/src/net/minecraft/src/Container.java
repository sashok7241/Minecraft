...
public abstract class Container
{
	...
	{
		if(crafters.contains(par1ICrafting)) throw new IllegalArgumentException("Listener already listening");
		else
		{
			crafters.add(par1ICrafting);
			par1ICrafting.sendContainerAndContentsToPlayer(this, getInventory());
				...
				if(var17 != null && (var16 == null || !var16.getHasStack() || !var16.canTakeStack(par4EntityPlayer)))
				{
					...
					for(int var20 = 0; var20 < 2; ++var20)
					{
						for(int var22 = var9; var22 >= 0 && var22 < inventorySlots.size() && var17.stackSize < var17.getMaxStackSize(); var22 += var21)
						{
							...
							if(var24.getHasStack() && func_94527_a(var24, var17, true) && var24.canTakeStack(par4EntityPlayer) && func_94530_a(var17, var24) && (var20 != 0 || var24.getStack().stackSize != var24.getStack().getMaxStackSize()))
							{
