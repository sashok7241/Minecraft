				...
				if((var8 == Block.grass.blockID || var8 == Block.dirt.blockID) && par4 < 256 - var6 - 1)
				{
					...
					for(int var14 = par4 + var6 - 2 - par2Random.nextInt(4); var14 > par4 + var6 / 2; var14 -= 2 + par2Random.nextInt(4))
					{
						...
						for(int var13 = 0; var13 < 5; ++var13)
						{
							...
							setBlockAndMetadata(par1World, var11, var14 - 3 + var13 / 2, var12, Block.wood.blockID, woodMetadata);
						}
					}
					for(var10 = 0; var10 < var6; ++var10)
					{
						...
						{
							setBlockAndMetadata(par1World, par3, par4 + var10, par5, Block.wood.blockID, woodMetadata);
							if(var10 > 0)
							{
								if(par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 - 1, par4 + var10, par5))
								{
									setBlockAndMetadata(par1World, par3 - 1, par4 + var10, par5, Block.vine.blockID, 8);
								}
								if(par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3, par4 + var10, par5 - 1))
								{
									setBlockAndMetadata(par1World, par3, par4 + var10, par5 - 1, Block.vine.blockID, 1);
								}
							}
						}
						if(var10 < var6 - 1)
						{
							...
							if(var11 == 0 || var11 == Block.leaves.blockID)
							{
								setBlockAndMetadata(par1World, par3 + 1, par4 + var10, par5, Block.wood.blockID, woodMetadata);
								if(var10 > 0)
								{
									if(par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 + 2, par4 + var10, par5))
									{
										setBlockAndMetadata(par1World, par3 + 2, par4 + var10, par5, Block.vine.blockID, 2);
									}
									if(par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 + 1, par4 + var10, par5 - 1))
									{
										setBlockAndMetadata(par1World, par3 + 1, par4 + var10, par5 - 1, Block.vine.blockID, 1);
									}
								}
							}
							...
							if(var11 == 0 || var11 == Block.leaves.blockID)
							{
								setBlockAndMetadata(par1World, par3 + 1, par4 + var10, par5 + 1, Block.wood.blockID, woodMetadata);
								if(var10 > 0)
								{
									if(par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 + 2, par4 + var10, par5 + 1))
									{
										setBlockAndMetadata(par1World, par3 + 2, par4 + var10, par5 + 1, Block.vine.blockID, 2);
									}
									if(par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 + 1, par4 + var10, par5 + 2))
									{
										setBlockAndMetadata(par1World, par3 + 1, par4 + var10, par5 + 2, Block.vine.blockID, 4);
									}
								}
							}
							...
							if(var11 == 0 || var11 == Block.leaves.blockID)
							{
								setBlockAndMetadata(par1World, par3, par4 + var10, par5 + 1, Block.wood.blockID, woodMetadata);
								if(var10 > 0)
								{
									if(par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 - 1, par4 + var10, par5 + 1))
									{
										setBlockAndMetadata(par1World, par3 - 1, par4 + var10, par5 + 1, Block.vine.blockID, 8);
									}
									if(par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3, par4 + var10, par5 + 2))
									{
										setBlockAndMetadata(par1World, par3, par4 + var10, par5 + 2, Block.vine.blockID, 4);
									}
								}
							}
						}
			...
			for(int var11 = par2 - var10; var11 <= par2 + var10 + 1; ++var11)
			{
				...
				for(int var13 = par3 - var10; var13 <= par3 + var10 + 1; ++var13)
				{
					...
					if((var12 >= 0 || var14 >= 0 || var12 * var12 + var14 * var14 <= var10 * var10) && (var12 <= 0 && var14 <= 0 || var12 * var12 + var14 * var14 <= (var10 + 1) * (var10 + 1)) && (par6Random.nextInt(4) != 0 || var12 * var12 + var14 * var14 <= (var10 - 1) * (var10 - 1)))
					{
						...
						{
							setBlockAndMetadata(par1World, var11, var8, var13, Block.leaves.blockID, leavesMetadata);
						}
					}
				}
			}
