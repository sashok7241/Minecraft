...
public class WorldGenDeadBush extends WorldGenerator
{
	...
	@Override public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
	{
		...
		for(int var7 = 0; var7 < 4; ++var7)
		{
			...
			if(par1World.isAirBlock(var8, var9, var10) && Block.blocksList[deadBushID].canBlockStay(par1World, var8, var9, var10))
			{
				par1World.setBlock(var8, var9, var10, deadBushID, 0, 2);
			}
		}
		return true;
	}
