	...
	@Override public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
	{
		...
		for(var4 = 7; var4 <= 11; ++var4)
		{
			for(var5 = 0; var5 <= 2; ++var5)
			{
				...
				fillCurrentPositionBlocksDownwards(par1World, Block.netherBrick.blockID, 0, var4, -1, 18 - var5, par3StructureBoundingBox);
			}
		}
		...
		for(var4 = 0; var4 <= 2; ++var4)
		{
			...
			{
				fillCurrentPositionBlocksDownwards(par1World, Block.netherBrick.blockID, 0, var4, -1, var5, par3StructureBoundingBox);
				fillCurrentPositionBlocksDownwards(par1World, Block.netherBrick.blockID, 0, 18 - var4, -1, var5, par3StructureBoundingBox);
			}
		}
		return true;
	}
