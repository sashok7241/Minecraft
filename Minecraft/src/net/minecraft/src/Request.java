...
public abstract class Request
{
	...
	public Request(String p_i10026_1_, int p_i10026_2_, int p_i10026_3_)
	{
		try
		{
			field_96365_b = p_i10026_1_;
			field_96367_a = (HttpURLConnection) new URL(p_i10026_1_).openConnection();
			field_96367_a.setConnectTimeout(p_i10026_2_);
			field_96367_a.setReadTimeout(p_i10026_3_);
