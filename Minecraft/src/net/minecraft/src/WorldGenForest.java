		...
		if(p_76484_4_ >= 1 && p_76484_4_ + var6 + 1 <= 256)
		{
			...
			else
			{
				...
				if((var8 == Block.grass.blockID || var8 == Block.dirt.blockID) && p_76484_4_ < 256 - var6 - 1)
				{
					...
					for(var17 = p_76484_4_ - 3 + var6; var17 <= p_76484_4_ + var6; ++var17)
					{
						...
						for(var12 = p_76484_3_ - var11; var12 <= p_76484_3_ + var11; ++var12)
						{
							...
							for(int var14 = p_76484_5_ - var11; var14 <= p_76484_5_ + var11; ++var14)
							{
								...
								{
									int var16 = p_76484_1_.getBlockId(var12, var17, var14);
									if(var16 == 0 || var16 == Block.leaves.blockID)
									{
										setBlockAndMetadata(p_76484_1_, var12, var17, var14, Block.leaves.blockID, 2);
									}
								}
							}
						}
					...
					{
						var10 = p_76484_1_.getBlockId(p_76484_3_, p_76484_4_ + var17, p_76484_5_);
						if(var10 == 0 || var10 == Block.leaves.blockID)
						{
							setBlockAndMetadata(p_76484_1_, p_76484_3_, p_76484_4_ + var17, p_76484_5_, Block.wood.blockID, 2);
						}
					}
					return true;
				} else return false;
