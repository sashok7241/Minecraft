...
public class ItemLeash extends Item
{
	...
	public static boolean func_135066_a(EntityPlayer par0EntityPlayer, World par1World, int par2, int par3, int par4)
	{
		...
		boolean var6 = false;
		double var7 = 7.0D;
		List var9 = par1World.getEntitiesWithinAABB(EntityLiving.class, AxisAlignedBB.getAABBPool().getAABB(par2 - var7, par3 - var7, par4 - var7, par2 + var7, par3 + var7, par4 + var7));
		if(var9 != null)
		{
