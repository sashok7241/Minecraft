...
public class FallbackResourceManager implements ResourceManager
{
	...
	{
		field_110539_b = par1MetadataSerializer;
	}
	...
	@Override public Resource func_110536_a(ResourceLocation par1ResourceLocation) throws IOException
	{
		...
		for(int var4 = field_110540_a.size() - 1; var4 >= 0; --var4)
		{
			...
			if(var5.func_110589_b(par1ResourceLocation))
			{
				...
				return new SimpleResource(par1ResourceLocation, var5.func_110590_a(par1ResourceLocation), var6, field_110539_b);
			}
		}
	...
	{
		field_110540_a.add(par1ResourcePack);
	}
	...
	@Override public List func_135056_b(ResourceLocation par1ResourceLocation) throws IOException
	{
		...
		while(var4.hasNext())
		{
			...
			if(var5.func_110589_b(par1ResourceLocation))
			{
				...
				var2.add(new SimpleResource(par1ResourceLocation, var5.func_110590_a(par1ResourceLocation), var6, field_110539_b));
			}
		}
		if(var2.isEmpty()) throw new FileNotFoundException(par1ResourceLocation.toString());
		else return var2;
	}
