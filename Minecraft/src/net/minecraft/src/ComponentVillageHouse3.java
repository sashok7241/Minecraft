...
public class ComponentVillageHouse3 extends ComponentVillage
{
	...
	@Override public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
	{
		...
		{
			placeBlockAtCurrentPosition(par1World, Block.planks.blockID, 0, var7, 2 + var7, 7 - var7, par3StructureBoundingBox);
			for(var8 = 8 - var7; var8 <= 10; ++var8)
			{
				placeBlockAtCurrentPosition(par1World, Block.stairsWoodOak.blockID, var6, var7, 2 + var7, var8, par3StructureBoundingBox);
			}
		}
		...
		placeBlockAtCurrentPosition(par1World, Block.stairsWoodOak.blockID, var7, 6, 6, 4, par3StructureBoundingBox);
		int var9;
		for(var8 = 6; var8 <= 8; ++var8)
		{
			for(var9 = 5; var9 <= 10; ++var9)
			{
				placeBlockAtCurrentPosition(par1World, Block.stairsWoodOak.blockID, var7, var8, 12 - var8, var9, par3StructureBoundingBox);
			}
		}
		...
		for(var8 = 0; var8 < 5; ++var8)
		{
			for(var9 = 0; var9 < 9; ++var9)
			{
				...
				fillCurrentPositionBlocksDownwards(par1World, Block.cobblestone.blockID, 0, var9, -1, var8, par3StructureBoundingBox);
			}
		}
