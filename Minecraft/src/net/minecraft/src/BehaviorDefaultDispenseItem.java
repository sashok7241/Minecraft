...
{
	@Override public final ItemStack dispense(IBlockSource par1IBlockSource, ItemStack par2ItemStack)
	{
		ItemStack var3 = dispenseStack(par1IBlockSource, par2ItemStack);
		playDispenseSound(par1IBlockSource);
		spawnDispenseParticles(par1IBlockSource, BlockDispenser.getFacing(par1IBlockSource.getBlockMetadata()));
		return var3;
	}
