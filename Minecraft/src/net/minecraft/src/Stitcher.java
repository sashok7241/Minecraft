...
public class Stitcher
{
	...
	public Stitcher(String p_i9010_1_, int p_i9010_2_, int p_i9010_3_, boolean p_i9010_4_, int p_i9010_5_)
	{
		...
		currentWidth = 0;
		currentHeight = 0;
		textureName = p_i9010_1_;
		maxWidth = p_i9010_2_;
		maxHeight = p_i9010_3_;
		forcePowerOf2 = p_i9010_4_;
		maxTileDimension = p_i9010_5_;
	}
	
	public void addStitchHolder(StitchHolder p_94312_1_)
	{
		if(maxTileDimension > 0)
		{
			p_94312_1_.setNewDimension(maxTileDimension);
		}
		setStitchHolders.add(p_94312_1_);
	}
