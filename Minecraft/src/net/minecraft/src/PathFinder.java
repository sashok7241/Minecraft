...
public class PathFinder
{
	...
	private PathEntity addToPath(Entity par1Entity, PathPoint par2PathPoint, PathPoint par3PathPoint, PathPoint par4PathPoint, float par5)
	{
		...
		if(var6 == par2PathPoint) return null;
		else return createEntityPath(par2PathPoint, var6);
	}
	...
	private PathEntity createEntityPathTo(Entity par1Entity, double par2, double par4, double par6, float par8)
	{
		...
		if(canEntityDrown && par1Entity.isInWater())
		{
			...
			for(int var11 = worldMap.getBlockId(MathHelper.floor_double(par1Entity.posX), var10, MathHelper.floor_double(par1Entity.posZ)); var11 == Block.waterMoving.blockID || var11 == Block.waterStill.blockID; var11 = worldMap.getBlockId(MathHelper.floor_double(par1Entity.posX), var10, MathHelper.floor_double(par1Entity.posZ)))
			{
				++var10;
			}
	...
	private PathPoint getSafePoint(Entity par1Entity, int par2, int par3, int par4, PathPoint par5PathPoint, int par6)
	{
		...
		if(var8 == 2) return openPoint(par2, par3, par4);
		else
		{
			if(var8 == 1)
			{
			...
			if(var7 != null)
			{
				...
				while(par3 > 0)
				{
					...
					if(var9++ >= par1Entity.func_82143_as()) return null;
					--par3;
					if(par3 > 0)
					{
						var7 = openPoint(par2, par3, par4);
			...
			for(int var10 = par2; var10 < par2 + par4PathPoint.yCoord; ++var10)
			{
				for(int var11 = par3; var11 < par3 + par4PathPoint.zCoord; ++var11)
				{
					...
					if(var12 > 0)
					{
						...
						{
							if(!par7 && var12 == Block.doorWood.blockID) return 0;
						} else
						{
							if(par5) return -1;
							var8 = true;
						...
						if(par0Entity.worldObj.blockGetRenderType(var9, var10, var11) == 9)
						{
							...
							if(par0Entity.worldObj.blockGetRenderType(var18, var16, var17) != 9 && par0Entity.worldObj.blockGetRenderType(var18, var16 - 1, var17) != 9) return -3;
