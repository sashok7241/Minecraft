...
public class MessageComponentSerializer implements JsonDeserializer, JsonSerializer
{
	...
	{
		return func_111056_a(par1JsonElement, par2Type, par3JsonDeserializationContext);
	}
	...
	public JsonElement func_111055_a(ChatMessageComponent par1ChatMessageComponent, Type par2Type, JsonSerializationContext par3JsonSerializationContext)
	{
		...
		} else if(par1ChatMessageComponent.func_111074_g() != null)
		{
			...
			{
				var4.add("using", func_111057_b(par1ChatMessageComponent, par2Type, par3JsonSerializationContext));
			}
		} else if(par1ChatMessageComponent.func_111069_h() != null && !par1ChatMessageComponent.func_111069_h().isEmpty())
		{
			var4.add("text", func_111057_b(par1ChatMessageComponent, par2Type, par3JsonSerializationContext));
		}
		return var4;
	}
		...
		if(var6 != null)
		{
			if(var6.isJsonArray())
			{
				...
				while(var14.hasNext())
				{
					...
					{
						var4.func_111073_a(func_111056_a(var15, par2Type, par3JsonDeserializationContext));
					}
				}
			...
			if(var17 != null)
			{
				if(var17.isJsonArray())
				{
					...
					while(var19.hasNext())
					{
						...
						{
							var20.add(func_111056_a(var16, par2Type, par3JsonDeserializationContext));
						}
					}
	...
	private JsonArray func_111057_b(ChatMessageComponent par1ChatMessageComponent, Type par2Type, JsonSerializationContext par3JsonSerializationContext)
	{
		...
		while(var5.hasNext())
		{
			...
			{
				var4.add(func_111055_a(var6, par2Type, par3JsonSerializationContext));
			}
		}
		return var4;
	}
	...
	{
		return func_111055_a((ChatMessageComponent) par1Obj, par2Type, par3JsonSerializationContext);
	}
}
