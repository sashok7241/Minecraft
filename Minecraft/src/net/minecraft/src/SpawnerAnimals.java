...
public final class SpawnerAnimals
{
	...
	{
		if(par0EnumCreatureType.getCreatureMaterial() == Material.water) return par1World.getBlockMaterial(par2, par3, par4).isLiquid() && par1World.getBlockMaterial(par2, par3 - 1, par4).isLiquid() && !par1World.isBlockNormalCube(par2, par3 + 1, par4);
		else if(!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4)) return false;
		else
		{
