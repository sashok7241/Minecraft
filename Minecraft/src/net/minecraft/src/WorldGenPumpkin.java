...
public class WorldGenPumpkin extends WorldGenerator
{
	@Override public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
	{
		for(int var6 = 0; var6 < 64; ++var6)
		{
			...
			if(p_76484_1_.isAirBlock(var7, var8, var9) && p_76484_1_.getBlockId(var7, var8 - 1, var9) == Block.grass.blockID && Block.pumpkin.canPlaceBlockAt(p_76484_1_, var7, var8, var9))
			{
				p_76484_1_.setBlock(var7, var8, var9, Block.pumpkin.blockID, p_76484_2_.nextInt(4), 2);
			}
		}
		return true;
	}
