...
public class MapGenRavine extends MapGenBase
{
										...
										if((var59 * var59 + var45 * var45) * field_75046_d[var49] + var50 * var50 / 6.0D < 1.0D)
										{
											...
											if(var52 == Block.stone.blockID || var52 == Block.dirt.blockID || var52 == Block.grass.blockID)
											{
												...
												} else
												{
													...
													{
														par5ArrayOfByte[var47 - 1] = worldObj.getBiomeGenForCoords(var41 + par3 * 16, var44 + par4 * 16).topBlock;
													}
												}
											}
										}
	...
	@Override protected void recursiveGenerate(World par1World, int par2, int par3, int par4, int par5, byte[] par6ArrayOfByte)
	{
		...
		{
			double var7 = par2 * 16 + rand.nextInt(16);
			double var9 = rand.nextInt(rand.nextInt(40) + 8) + 20;
			double var11 = par3 * 16 + rand.nextInt(16);
			byte var13 = 1;
			for(int var14 = 0; var14 < var13; ++var14)
			{
				...
				generateRavine(rand.nextLong(), par4, par5, par6ArrayOfByte, var7, var9, var11, var17, var15, var16, 0, 0, 3.0D);
			}
		}
	}
}
