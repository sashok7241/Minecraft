...
public class ComponentNetherBridgeCorridor4 extends ComponentNetherBridgePiece
{
	...
	@Override public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
	{
		...
		for(int var4 = 0; var4 <= 5; ++var4)
		{
			...
			{
				fillCurrentPositionBlocksDownwards(par1World, Block.netherBrick.blockID, 0, var5, -1, var4, par3StructureBoundingBox);
			}
		}
		return true;
	}
	...
	@Override public void buildComponent(StructureComponent par1StructureComponent, List par2List, Random par3Random)
	{
		...
		getNextComponentX((ComponentNetherBridgeStartPiece) par1StructureComponent, par2List, par3Random, 0, var4, par3Random.nextInt(8) > 0);
		getNextComponentZ((ComponentNetherBridgeStartPiece) par1StructureComponent, par2List, par3Random, 0, var4, par3Random.nextInt(8) > 0);
	}
