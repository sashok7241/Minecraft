	...
	public void addRecipes(CraftingManager p_77586_1_)
	{
		for(int var2 = 0; var2 < recipeItems[0].length; ++var2)
		{
			...
			for(int var4 = 0; var4 < recipeItems.length - 1; ++var4)
			{
				...
				p_77586_1_.addRecipe(new ItemStack(var5), new Object[] { recipePatterns[var4], '#', Item.stick, 'X', var3 });
			}
		}
		p_77586_1_.addRecipe(new ItemStack(Item.shears), new Object[] { " #", "# ", '#', Item.ingotIron });
	}
}
