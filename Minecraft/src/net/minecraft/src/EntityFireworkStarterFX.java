...
public class EntityFireworkStarterFX extends EntityFX
{
	...
	public EntityFireworkStarterFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12, EffectRenderer par14EffectRenderer, NBTTagCompound par15NBTTagCompound)
	{
		...
		if(par15NBTTagCompound != null)
		{
			...
			} else
			{
				...
				{
					NBTTagCompound var17 = (NBTTagCompound) fireworkExplosions.tagAt(var16);
	...
	{
		EntityFireworkSparkFX var17 = new EntityFireworkSparkFX(worldObj, par1, par3, par5, par7, par9, par11, field_92040_ay);
		var17.func_92045_e(par15);
		var17.func_92043_f(par16);
		int var18 = rand.nextInt(par13ArrayOfInteger.length);
		var17.func_92044_a(par13ArrayOfInteger[var18]);
		if(par14ArrayOfInteger != null && par14ArrayOfInteger.length > 0)
		{
			var17.func_92046_g(par14ArrayOfInteger[rand.nextInt(par14ArrayOfInteger.length)]);
		}
		...
		for(int var14 = -par3; var14 <= par3; ++var14)
		{
			for(int var15 = -par3; var15 <= par3; ++var15)
			{
				for(int var16 = -par3; var16 <= par3; ++var16)
				{
					...
					double var23 = MathHelper.sqrt_double(var17 * var17 + var19 * var19 + var21 * var21) / par1 + rand.nextGaussian() * 0.05D;
					func_92034_a(var8, var10, var12, var17 / var23, var19 / var23, var21 / var23, par4ArrayOfInteger, par5ArrayOfInteger, par6, par7);
	...
	private void func_92036_a(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, boolean par3, boolean par4)
	{
		...
		for(int var9 = 0; var9 < 70; ++var9)
		{
			...
			func_92034_a(posX, posY, posZ, var10, var14, var12, par1ArrayOfInteger, par2ArrayOfInteger, par3, par4);
		}
	}
	...
	private boolean func_92037_i()
	{
		...
		return var1 == null || var1.renderViewEntity == null || var1.renderViewEntity.getDistanceSq(posX, posY, posZ) >= 256.0D;
	}
	...
	private void func_92038_a(double par1, double[][] par3ArrayOfDouble, int[] par4ArrayOfInteger, int[] par5ArrayOfInteger, boolean par6, boolean par7, boolean par8)
	{
		...
		func_92034_a(posX, posY, posZ, var9 * par1, var11 * par1, 0.0D, par4ArrayOfInteger, par5ArrayOfInteger, par6, par7);
		float var13 = rand.nextFloat() * (float) Math.PI;
		...
		for(int var16 = 0; var16 < 3; ++var16)
		{
			...
			for(int var23 = 1; var23 < par3ArrayOfDouble.length; ++var23)
			{
				...
				for(double var28 = 0.25D; var28 <= 1.0D; var28 += 0.25D)
				{
					...
					{
						func_92034_a(posX, posY, posZ, var30 * var36, var32, var34 * var36, par4ArrayOfInteger, par5ArrayOfInteger, par6, par7);
					}
				}
				var19 = var24;
				var21 = var26;
	...
	@Override public void onUpdate()
	{
		...
		if(field_92042_ax == 0 && fireworkExplosions != null)
		{
			...
			} else
			{
				...
				{
					NBTTagCompound var4 = (NBTTagCompound) fireworkExplosions.tagAt(var3);
			...
			worldObj.playSound(posX, posY, posZ, var15, 20.0F, 0.95F + rand.nextFloat() * 0.1F, true);
		}
		if(field_92042_ax % 2 == 0 && fireworkExplosions != null && field_92042_ax / 2 < fireworkExplosions.tagCount())
		{
			int var13 = field_92042_ax / 2;
			NBTTagCompound var14 = (NBTTagCompound) fireworkExplosions.tagAt(var13);
			...
			{
				func_92038_a(0.5D, new double[][] { { 0.0D, 1.0D }, { 0.3455D, 0.309D }, { 0.9511D, 0.309D }, { 0.3795918367346939D, -0.12653061224489795D }, { 0.6122448979591837D, -0.8040816326530612D }, { 0.0D, -0.35918367346938773D } }, var6, var7, var18, var5, false);
			} else if(var17 == 3)
			{
				func_92038_a(0.5D, new double[][] { { 0.0D, 0.2D }, { 0.2D, 0.2D }, { 0.2D, 0.6D }, { 0.6D, 0.6D }, { 0.6D, 0.2D }, { 0.2D, 0.2D }, { 0.2D, 0.0D }, { 0.4D, 0.0D }, { 0.4D, -0.6D }, { 0.2D, -0.6D }, { 0.2D, -0.4D }, { 0.0D, -0.4D } }, var6, var7, var18, var5, true);
			} else if(var17 == 4)
			{
		...
		if(field_92042_ax > particleMaxAge)
		{
			if(field_92041_a)
			{
				...
				worldObj.playSound(posX, posY, posZ, var16, 20.0F, 0.9F + rand.nextFloat() * 0.15F, true);
			}
			setDead();
		}
	}
