	...
	protected void func_96450_a(EntityPlayer par1EntityPlayer, double par2, double par4, double par6, String par8Str, float par9, double par10)
	{
		if(par10 < 100.0D)
		{
			...
			if(var13 != null)
			{
				...
				{
					renderLivingLabel(par1EntityPlayer, var14.getScorePoints() + " " + var13.getDisplayName(), par2, par4 - 1.5D, par6, 64);
				} else
				{
					renderLivingLabel(par1EntityPlayer, var14.getScorePoints() + " " + var13.getDisplayName(), par2, par4, par6, 64);
				}
	...
	protected void renderSpecials(EntityPlayer par1EntityPlayer, float par2)
	{
		...
		if(var4 != null)
		{
			...
			if(var4.getItem().itemID < 256)
			{
				...
				renderManager.itemRenderer.renderItem(par1EntityPlayer, var4, 0);
