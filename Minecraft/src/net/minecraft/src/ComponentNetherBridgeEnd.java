...
public class ComponentNetherBridgeEnd extends ComponentNetherBridgePiece
{
	...
	@Override public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
	{
		...
		for(var5 = 0; var5 <= 4; ++var5)
		{
			...
			{
				var7 = var4.nextInt(8);
				fillWithBlocks(par1World, par3StructureBoundingBox, var5, var6, 0, var5, var6, var7, Block.netherBrick.blockID, Block.netherBrick.blockID, false);
			}
		}
		var5 = var4.nextInt(8);
		fillWithBlocks(par1World, par3StructureBoundingBox, 0, 5, 0, 0, 5, var5, Block.netherBrick.blockID, Block.netherBrick.blockID, false);
		var5 = var4.nextInt(8);
		fillWithBlocks(par1World, par3StructureBoundingBox, 4, 5, 0, 4, 5, var5, Block.netherBrick.blockID, Block.netherBrick.blockID, false);
		for(var5 = 0; var5 <= 4; ++var5)
		{
			var6 = var4.nextInt(5);
			fillWithBlocks(par1World, par3StructureBoundingBox, var5, 2, 0, var5, 2, var6, Block.netherBrick.blockID, Block.netherBrick.blockID, false);
		}
		for(var5 = 0; var5 <= 4; ++var5)
		{
