...
public class McoClient
{
	...
	{
		field_96390_a = p_i20001_1_.sessionId;
		field_100007_c = p_i20001_1_.username;
	}
	...
	public Boolean func_96376_d(long par1, String par3Str) throws ExceptionMcoService, UnsupportedEncodingException
	{
		...
		{
			var4.append("?seed=").append(func_96380_a(par3Str));
		}
	...
	public Boolean func_96378_c(long par1) throws ExceptionMcoService, IOException
	{
		...
		String var4 = func_96377_a(Request.func_96363_c(var3, ""));
	...
	public void func_96384_a(long par1, String par3Str, String par4Str, int par5, int par6) throws ExceptionMcoService, UnsupportedEncodingException
	{
		...
		var7.append(field_96388_b).append("worlds").append("/$WORLD_ID/$NAME".replace("$WORLD_ID", String.valueOf(par1)).replace("$NAME", func_96380_a(par3Str)));
		if(par4Str != null && !par4Str.trim().equals(""))
		{
			var7.append("?motd=").append(func_96380_a(par4Str));
		}
		var7.append("&difficulty=").append(par5).append("&gameMode=").append(par6);
		func_96377_a(Request.func_96363_c(var7.toString(), ""));
	}
	...
	public void func_96386_a(String par1Str, String par2Str, String par3Str, String par4Str) throws ExceptionMcoService, UnsupportedEncodingException
	{
		...
		if(!var6.isEmpty())
		{
			boolean var7 = true;
			Entry var9;
			for(Iterator var8 = var6.entrySet().iterator(); var8.hasNext(); var5.append((String) var9.getKey()).append("=").append(func_96380_a((String) var9.getValue())))
			{
		...
		func_96377_a(Request.func_104064_a(var5.toString(), "", 5000, 30000));
	}
	...
	{
		String var3 = func_96377_a(Request.func_96358_a(field_96388_b + "worlds" + "/$ID".replace("$ID", String.valueOf(par1))));
	...
	{
		String var3 = func_96377_a(Request.func_96358_a(field_96388_b + "subscriptions" + "/$WORLD_ID".replace("$WORLD_ID", String.valueOf(par1))));
