...
class McoServerListUpdateTaskComparator implements Comparator
{
	...
	{
		field_140070_a = par1McoServerListUpdateTask;
		field_140069_b = par2Str;
	}
	...
	public int func_140068_a(McoServer par1McoServer, McoServer par2McoServer)
	{
		...
		else if(par1McoServer.field_96405_e.equals(field_140069_b)) return -1;
		else if(par2McoServer.field_96405_e.equals(field_140069_b)) return 1;
		else
		{
