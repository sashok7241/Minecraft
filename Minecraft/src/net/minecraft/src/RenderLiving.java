...
public class RenderLiving extends Render
{
	...
	{
		mainModel = p_i3199_1_;
		shadowSize = p_i3199_2_;
	}
	...
	protected void func_96449_a(EntityLiving par1EntityLivingBase, double par2, double par4, double par6, String par8Str, float par9, double par10)
	{
	...
	{
		loadTexture(p_98190_1_.getTexture());
	}
	...
	protected float getDeathMaxRotation(EntityLiving par1EntityLivingBase)
	{
		return 90.0F;
	}
	
	protected float handleRotationFloat(EntityLiving par1EntityLivingBase, float par2)
	{
		return par1EntityLivingBase.ticksExisted + par2;
	}
	
	protected int inheritRenderPass(EntityLiving par1EntityLivingBase, int par2, float par3)
	{
	...
	protected void passSpecialRender(EntityLiving par1EntityLivingBase, double par2, double par4, double par6)
	{
		if(Minecraft.isGuiEnabled() && par1EntityLivingBase != renderManager.livingPlayer && !par1EntityLivingBase.func_98034_c(Minecraft.getMinecraft().thePlayer) && (par1EntityLivingBase.getAlwaysRenderNameTagForRender() || par1EntityLivingBase.hasCustomNameTag() && par1EntityLivingBase == renderManager.field_96451_i))
		{
			float var8 = 1.6F;
	...
	protected void renderArrowsStuckInEntity(EntityLiving par1EntityLivingBase, float par2)
	{
	...
	protected void renderLivingAt(EntityLiving par1EntityLivingBase, double par2, double par4, double par6)
	{
		GL11.glTranslatef((float) par2, (float) par4, (float) par6);
	}
	
	protected void renderLivingLabel(EntityLiving par1EntityLivingBase, String par2Str, double par3, double par5, double par7, int par9)
	{
		double var10 = par1EntityLivingBase.getDistanceSqToEntity(renderManager.livingPlayer);
		if(var10 <= par9 * par9)
		{
	...
	protected void renderModel(EntityLiving par1EntityLivingBase, float par2, float par3, float par4, float par5, float par6, float par7)
	{
		func_98190_a(par1EntityLivingBase);
	...
	protected float renderSwingProgress(EntityLiving par1EntityLivingBase, float par2)
	{
	...
	protected int shouldRenderPass(EntityLiving par1EntityLivingBase, int par2, float par3)
	{
		return -1;
	}
}
