...
public class BlockTNT extends Block
{
	...
	@Override public boolean canDropFromExplosion(Explosion par1Explosion)
	{
		return false;
	}
	...
	@Override public void onBlockDestroyedByExplosion(World par1World, int par2, int par3, int par4, Explosion par5Explosion)
	{
		if(!par1World.isRemote)
		{
			EntityTNTPrimed var6 = new EntityTNTPrimed(par1World, par2 + 0.5F, par3 + 0.5F, par4 + 0.5F, par5Explosion.func_94613_c());
