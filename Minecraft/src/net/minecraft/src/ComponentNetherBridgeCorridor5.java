...
public class ComponentNetherBridgeCorridor5 extends ComponentNetherBridgePiece
{
	...
	{
		super(p_i3822_1_);
		coordBaseMode = p_i3822_4_;
		boundingBox = p_i3822_3_;
	}
	...
	public static ComponentNetherBridgeCorridor5 createValidComponent(List p_74981_0_, Random p_74981_1_, int p_74981_2_, int p_74981_3_, int p_74981_4_, int p_74981_5_, int p_74981_6_)
	{
		...
		return isAboveGround(var7) && StructureComponent.findIntersecting(p_74981_0_, var7) == null ? new ComponentNetherBridgeCorridor5(p_74981_6_, p_74981_1_, var7, p_74981_5_) : null;
	}
}
