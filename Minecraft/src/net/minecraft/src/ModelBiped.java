...
public class ModelBiped extends ModelBase
{
	...
	public ModelBiped(float p_i5021_1_, float p_i5021_2_, int p_i5021_3_, int p_i5021_4_)
	{
		...
		isSneak = false;
		aimedBow = false;
		textureWidth = p_i5021_3_;
		textureHeight = p_i5021_4_;
		bipedCloak = new ModelRenderer(this, 0, 0);
		bipedCloak.addBox(-5.0F, 0.0F, -1.0F, 10, 16, 1, p_i5021_1_);
		bipedEars = new ModelRenderer(this, 24, 0);
		bipedEars.addBox(-3.0F, -6.0F, -1.0F, 6, 6, 1, p_i5021_1_);
		bipedHead = new ModelRenderer(this, 0, 0);
		bipedHead.addBox(-4.0F, -8.0F, -4.0F, 8, 8, 8, p_i5021_1_);
		bipedHead.setRotationPoint(0.0F, 0.0F + p_i5021_2_, 0.0F);
		bipedHeadwear = new ModelRenderer(this, 32, 0);
		bipedHeadwear.addBox(-4.0F, -8.0F, -4.0F, 8, 8, 8, p_i5021_1_ + 0.5F);
		bipedHeadwear.setRotationPoint(0.0F, 0.0F + p_i5021_2_, 0.0F);
		bipedBody = new ModelRenderer(this, 16, 16);
		bipedBody.addBox(-4.0F, 0.0F, -2.0F, 8, 12, 4, p_i5021_1_);
		bipedBody.setRotationPoint(0.0F, 0.0F + p_i5021_2_, 0.0F);
		bipedRightArm = new ModelRenderer(this, 40, 16);
		bipedRightArm.addBox(-3.0F, -2.0F, -2.0F, 4, 12, 4, p_i5021_1_);
		bipedRightArm.setRotationPoint(-5.0F, 2.0F + p_i5021_2_, 0.0F);
		bipedLeftArm = new ModelRenderer(this, 40, 16);
		bipedLeftArm.mirror = true;
		bipedLeftArm.addBox(-1.0F, -2.0F, -2.0F, 4, 12, 4, p_i5021_1_);
		bipedLeftArm.setRotationPoint(5.0F, 2.0F + p_i5021_2_, 0.0F);
		bipedRightLeg = new ModelRenderer(this, 0, 16);
		bipedRightLeg.addBox(-2.0F, 0.0F, -2.0F, 4, 12, 4, p_i5021_1_);
		bipedRightLeg.setRotationPoint(-1.9F, 12.0F + p_i5021_2_, 0.0F);
		bipedLeftLeg = new ModelRenderer(this, 0, 16);
		bipedLeftLeg.mirror = true;
		bipedLeftLeg.addBox(-2.0F, 0.0F, -2.0F, 4, 12, 4, p_i5021_1_);
		bipedLeftLeg.setRotationPoint(1.9F, 12.0F + p_i5021_2_, 0.0F);
	}
