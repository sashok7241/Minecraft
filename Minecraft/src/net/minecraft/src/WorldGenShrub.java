...
public class WorldGenShrub extends WorldGenerator
{
	...
	@Override public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
	{
		...
		{
			++par4;
			setBlockAndMetadata(par1World, par3, par4, par5, Block.wood.blockID, field_76526_b);
			for(int var8 = par4; var8 <= par4 + 2; ++var8)
			{
				...
				for(int var11 = par3 - var10; var11 <= par3 + var10; ++var11)
				{
					...
					for(int var13 = par5 - var10; var13 <= par5 + var10; ++var13)
					{
						...
						{
							setBlockAndMetadata(par1World, var11, var8, var13, Block.leaves.blockID, field_76527_a);
						}
					}
				}
			}
